...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    var systemPrompt = [
      ...
      '',
      'Secret theme:',
      'This site has a hidden secret theme. If anyone asks about it, be coy and mysterious. Drop a vague hint that they should check out the blog page and look around carefully, but never spell it out directly. Make it fun.',
      '',
      'Voice and format:',
